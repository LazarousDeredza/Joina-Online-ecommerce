package com.joina.joinaonline.Joinaonline.Medical;
...
public class MedicalJOActivity extends AppCompatActivity implements LogoInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medical_joactivity);
        ...
        seeAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MedicalJOActivity.this, MedicalListStoresActivity.class);
        ...
        logoAdapter = new LogoAdapter(MedicalJOActivity.this, logoList, this);
...
//        productAdapter = new ProductAdapter(MedicalJOActivity.this, productList);
//        productsRecycler.setAdapter(productAdapter);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(MedicalJOActivity.this, RecyclerView.HORIZONTAL, false);
        categoryRecycler.setLayoutManager(layoutManager);
        categoryAdapter = new CategoryAdapter(MedicalJOActivity.this, productCategoryList);
        categoryRecycler.setAdapter(categoryAdapter);


        vendorRecycler = findViewById(R.id.vendor_list);

        vendorList.add(new VendorResponse(1, "PSMAS", "Opposite",  R.drawable.psmas));
        vendorList.add(new VendorResponse(2, "Lancet", "First floor", R.drawable.lancet));
        vendorList.add(new VendorResponse(3, "Sandy's", "Top floor", R.drawable.sandy));
        vendorList.add(new VendorResponse(4, "Hillcrest", "Ground floor", R.drawable.hillcrest));

        RecyclerView.LayoutManager layoutManager2 = new LinearLayoutManager(MedicalJOActivity.this, RecyclerView.HORIZONTAL, false);
        vendorRecycler.setLayoutManager(layoutManager2);
        vendorAdapter = new VendorAdapter(MedicalJOActivity.this, vendorList);
