...
import com.joina.joinaonline.Joinaonline.Interfaces.AddorRemoveCallbacks;
import com.joina.joinaonline.Joinaonline.ProductActivity;
import com.joina.joinaonline.Joinaonline.ProductViewActivity;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.supplierName.setText(product.getSupplierName());
        ...
        Picasso.get()
                .load(product.getSupplierImage())
                .into(holder.supplierImage, new Callback() {
                    @Override
                    public void onSuccess() {
                        holder.progressBar.setVisibility(View.GONE);
                    }
        ...
        if (!cartList.isEmpty()) {
            for (int i = 0; i < cartList.size(); i++) {
                if (cartList.get(i).getId().equalsIgnoreCase(product.getId())) {
                    ...
                    holder.subTotal.setText(_quantity + "X" + _price + "= Zwl." + _subtotal);
            ...
            public void onClick(View v) {
                ...
                if (Integer.parseInt(_quantity) != 0) {
                    ...
                    if (context instanceof ProductActivity) {
                        ...
                        cart.setSupplier(product.getSupplierName());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ImageView imageView, supplierImage;
        TextView title, supplierName;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            supplierImage = itemView.findViewById(R.id.supplier_image);
