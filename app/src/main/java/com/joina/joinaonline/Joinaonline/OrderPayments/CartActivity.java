...
public class CartActivity extends BaseActivity {
    ...
    RelativeLayout emptyCart,cartHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gson = new Gson();
        emptyCart = findViewById(R.id.display_empty_cart);
        shopNow =findViewById(R.id.shop_now);
        cartHolder = findViewById(R.id.cartHolder);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.cart_delete) {
            ...
            Intent intent = new Intent(CartActivity.this, JoinaOnlineHomeActivity.class);
